        ...
        <div className="container-wide grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 space-y-2 text-navy/80 text-sm">
              ...
              <p><span className="text-gold uppercase tracking-widewide text-xs mr-2">Social</span><a href="https://www.instagram.com/ashley_m_smith26/" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition">Instagram</a> · <a href="https://www.facebook.com/ashleym.smith28" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition">Facebook</a> · <a href="https://www.compass.com/agents/ashley-smith/" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition">Compass</a></p>
            </div>
            <div className="mt-8">
