      ...
      <div className="container-wide py-16 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-ivory/80">
            ...
            <li><Link href="/client-portal" className="hover:text-gold">Client Portal</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-ivory/80">
            ...
            <li><a href="https://www.facebook.com/ashleym.smith28" target="_blank" rel="noopener noreferrer" className="hover:text-gold">Facebook</a></li>
