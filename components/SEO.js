...
export default function SEO({
  ...
  const desc =
    description ||
    'Thoughtful, refined, people-first real estate guidance for Chapel Hill, Carrboro, and the Triangle. Luxury Certified and Relocation Certified Realtor® with Compass North Carolina, LLC.';
  return (
    <Head>
